...
def find_number_vowels(text):
    ...
    for char in vowels:  # Оператор цикла: перебор каждой гласной буквы
        sum_number_vowels += text.count(
            char)  # Оператор присваивания: увеличение счетчика на количество вхождений гласной
...
def main():
    ...
    while flag_1:  # Оператор цикла: выполнение до изменения флага
        ...
        initial_choice = input(
            f"Добро пожаловать в анализатор текста!\nвведите 1 если хотите ввести строчку в ручную и 2 если хотите ввести название файла (изначально {name_file}) и 3 если хотите выйти: ")
